...
?>
            <div class="fotawp-admin-notice notice notice-info updated is-dismissible content-install-plugin theme-info-notice" id="fotawp-dismiss-notice">
                ...
                <div class="info-content">
                    ...
                    <h2><?php echo __('🚀 Take your website building to next level with Cozy Blocks! 🎉', 'fotawp'); ?></h2>

                    <h3><?php echo __('Build website for any niche effortlessly with Cozy Blocks! Just install and activate to access over 30 advanced blocks, 200+ ready to use patterns, and a comprehensive library of 10+ starter templates. Start crafting your perfect website today!', 'fotawp'); ?>
                    </h3>
                    <p><?php echo __('Please install and activate all recommended to use blcoks and demo importer features- Cozy Addons, Cozy Essential Addons, Advanced Import.', 'fotawp') ?></p>
